...
from diffusers.pipelines.deprecated.stable_diffusion_variants.pipeline_stable_diffusion_pix2pix_zero import Pix2PixInversionPipelineOutput
from diffusers.schedulers.scheduling_ddim_inverse import DDIMSchedulerOutput

from pipelines.sd.FixedPointInversion.pipeline_stable_diffusion_debug import StableDiffusionPipelineDebug


class StableDiffusionPipelineWithDDIMInversion(StableDiffusionPipelineDebug):
